...
<body>
  ...
  <section id="intro">
    <div class="intro-container wow fadeIn">
      ...
      <?php
        ...
        mysqli_select_db($Con,"books_reseller");
  ...
  <!--=======================
        Edit Profile
    ========================-->
    <section id="editprofile" class="wow fadeInUp">
      ...
      <div class="container ">
        ...
        <form class="row login_form" action="edit.php" method="post" id="contactForm" >
          <div class="col-md-12 form-group">
       <h4>Name</h4>
      <input type="name" class="form-control" id="name" name="name" value="Enter Name">
          </div>
      <div class="col-md-12 form-group">
      <h4>Contact Number</h4>
      <input type="phone" class="form-control" id="Contact" name="Contact" placeholder="Enter Contact Number">
          </div>
      <div class="col-md-12 form-group">
          <h4>Email</h4>
      ...
      <h4>Confirm password</h4>
            <input type="password" class="form-control" id="password" name="pass" placeholder="Confirm Password">
          </div>
          <div class="col-md-12 form-group">
            <button type="submit" value="submit" name="submit" class="btn submit_btn">Edit</button>&nbsp;&nbsp;&nbsp;
